-- Complete Production Database Schema Setup
-- Run this in Supabase Production Dashboard → SQL Editor
-- This creates ALL tables needed for full functionality

-- Enable UUID extension if not already enabled
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- 1. Core Tables (Users already exists)
...
-- 2. Communication & Notifications Tables
...
CREATE TABLE IF NOT EXISTS email_templates (
  ...
  template_engine TEXT DEFAULT 'handlebars',
...
DO $$
BEGIN
  RAISE NOTICE 'All production tables created successfully!';
  RAISE NOTICE 'Tables created: clients, bookings, contracts, invoices, unparseable_messages, feedback, email_templates, sms_verifications, booking_conflicts, conflict_resolutions';
  RAISE NOTICE 'Next step: Transfer user data from development database';
END $$;