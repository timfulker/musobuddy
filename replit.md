...
Travel expense integration: SIMPLIFIED SYSTEM - Travel expenses are always included in the performance fee display as a single amount to eliminate calculation confusion. The previous toggle system was removed to ensure consistent calculations across AI responses, booking displays, and contract generation. All fees are now displayed as a single total (e.g., £310 "inc. travel") with optional breakdown in subtitles. This prevents inconsistencies where AI would quote £310 but the system might show £310 + £0 travel, ensuring clear and consistent client communications.
