...
export const INSTRUMENT_GIG_PRESETS: InstrumentPreset[] = [
    ...
    gigTypes: [
      {
        id: "wedding-oboe",
        name: "Wedding Ceremony",
        description: "Classical oboe music for wedding ceremonies",
        defaultDuration: "30-45 minutes",
        priceRange: "£200-400",
        commonVenues: ["Churches", "Hotels", "Gardens", "Registry offices"]
      },
      {
        id: "classical-oboe",
        name: "Classical Performance",
        description: "Solo oboe or chamber music performance",
        defaultDuration: "1-2 hours",
        priceRange: "£300-600",
        commonVenues: ["Concert halls", "Churches", "Private venues", "Schools"]
      },
      {
        ...
        description: "Oboe section work in orchestras and ensembles",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
      ...
      },
      {
        id: "chamber-oboe",
        name: "Chamber Music",
        description: "Oboe in woodwind quintet or chamber ensemble",
        defaultDuration: "1-2 hours",
        priceRange: "£250-500",
        commonVenues: ["Private venues", "Hotels", "Corporate events", "Churches"]
      }
    ]
  },
  {
    ...
    gigTypes: [
      {
        id: "wedding-bassoon",
        name: "Wedding Ceremony",
        description: "Classical bassoon music for wedding ceremonies",
        defaultDuration: "30-45 minutes",
        priceRange: "£200-400",
        commonVenues: ["Churches", "Hotels", "Gardens", "Registry offices"]
      },
      {
        ...
        name: "Classical Performance",
        description: "Solo bassoon or chamber music performance",
        defaultDuration: "1-2 hours",
        priceRange: "£300-600",
        commonVenues: ["Concert halls", "Churches", "Private venues", "Schools"]
      },
      {
        id: "orchestral-bassoon",
        name: "Orchestral Performance",
        description: "Bassoon section work in orchestras and ensembles",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "chamber-bassoon",
        name: "Chamber Music",
        description: "Bassoon in woodwind quintet or chamber ensemble",
        defaultDuration: "1-2 hours",
        priceRange: "£250-500",
        commonVenues: ["Private venues", "Hotels", "Corporate events", "Churches"]
      }
    ...
    gigTypes: [
      {
        id: "wedding-horn",
        name: "Wedding Ceremony",
        description: "French horn fanfares and ceremony music",
        defaultDuration: "30-60 minutes",
        priceRange: "£200-400",
        commonVenues: ["Churches", "Hotels", "Outdoor venues", "Registry offices"]
      },
      {
        id: "orchestral-horn",
        name: "Orchestral Performance",
        description: "French horn section work in orchestras",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "brass-quintet-horn",
        name: "Brass Quintet",
        description: "French horn in brass quintet or ensemble",
        defaultDuration: "1-2 hours",
        priceRange: "£200-350",
        commonVenues: ["Churches", "Outdoor events", "Hotels", "Corporate venues"]
      },
      {
        id: "classical-horn",
        name: "Classical Performance",
        description: "Solo French horn or chamber music",
        defaultDuration: "1-2 hours",
        priceRange: "£300-600",
        commonVenues: ["Concert halls", "Churches", "Private venues", "Schools"]
      }
    ...
    gigTypes: [
      {
        id: "brass-band-tuba",
        name: "Brass Band",
        description: "Tuba in brass bands and wind ensembles",
        defaultDuration: "1-3 hours",
        priceRange: "£150-300",
        commonVenues: ["Bandstands", "Parks", "Community events", "Concerts"]
      },
      {
        id: "orchestral-tuba",
        name: "Orchestral Performance",
        description: "Tuba section work in orchestras",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "wedding-tuba",
        name: "Wedding Entertainment",
        description: "Tuba in brass ensembles for weddings",
        defaultDuration: "1-2 hours",
        priceRange: "£200-400",
        commonVenues: ["Churches", "Hotels", "Outdoor venues", "Function rooms"]
      },
      {
        id: "chamber-tuba",
        name: "Chamber Music",
        description: "Tuba in brass quintet or small ensemble",
        defaultDuration: "1-2 hours",
        priceRange: "£200-350",
        commonVenues: ["Churches", "Hotels", "Corporate events", "Private venues"]
      }
    ]
  },
  {
    ...
    gigTypes: [
      {
        ...
        name: "Orchestral Performance",
        description: "Percussion section work in orchestras",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "wedding-percussion",
        name: "Wedding Entertainment",
        description: "Percussion accompaniment for wedding celebrations",
        defaultDuration: "2-4 hours",
        priceRange: "£250-500",
        commonVenues: ["Hotels", "Wedding venues", "Function rooms", "Outdoor venues"]
      },
      {
        id: "world-music-percussion",
        name: "World Music",
        description: "Traditional and world percussion performance",
        defaultDuration: "1-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Cultural venues", "Festivals", "Private events", "Restaurants"]
      },
      {
        id: "educational-percussion",
        name: "Educational Workshop",
        description: "Percussion workshops and educational performances",
        defaultDuration: "1-2 hours",
        priceRange: "£150-350",
        commonVenues: ["Schools", "Community centers", "Music venues", "Workshops"]
      }
    ]
  },
  {
    ...
    gigTypes: [
      {
        ...
        name: "Orchestral Performance",
        description: "Timpani in orchestras and large ensembles",
        defaultDuration: "2-3 hours",
        priceRange: "£250-500",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "classical-timpani",
        name: "Classical Concert",
        description: "Timpani in classical and symphonic works",
        defaultDuration: "1-3 hours",
        priceRange: "£200-450",
        commonVenues: ["Concert halls", "Churches", "Festival venues", "Schools"]
      },
      {
        id: "ceremonial-timpani",
        name: "Ceremonial Performance",
        description: "Timpani for formal ceremonies and events",
        defaultDuration: "30-90 minutes",
        priceRange: "£300-600",
        commonVenues: ["Churches", "Corporate events", "Government venues", "Graduations"]
      },
      {
        id: "wind-band-timpani",
        name: "Wind Band",
        description: "Timpani in wind bands and brass ensembles",
        defaultDuration: "1-2 hours",
        priceRange: "£200-400",
        commonVenues: ["Bandstands", "Schools", "Community venues", "Outdoor events"]
      }
    ]
  },
  {
    ...
    gigTypes: [
      ...
      },
      {
        id: "wedding-viola",
        name: "Wedding Ceremony",
        description: "Viola performance for wedding ceremonies",
        defaultDuration: "30-90 minutes",
        priceRange: "£200-400",
        commonVenues: ["Churches", "Private homes", "Function rooms", "Outdoor venues"]
      },
      {
        id: "orchestral-viola",
        name: "Orchestral Performance",
        description: "Viola section work in orchestras",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "chamber-viola",
        name: "Chamber Music",
        description: "Viola in chamber ensembles and small groups",
        defaultDuration: "1-2 hours",
        priceRange: "£250-500",
        commonVenues: ["Private venues", "Hotels", "Corporate events", "Churches"]
      }
  ...
  },
  {
    ...
    gigTypes: [
      ...
      {
        id: "orchestral-double-bass",
        name: "Orchestral Performance",
        description: "Double bass section work in orchestras",
        defaultDuration: "2-3 hours",
        priceRange: "£200-400",
        commonVenues: ["Concert halls", "Theaters", "Opera houses", "Festival venues"]
      },
      {
        id: "chamber-double-bass",
        name: "Chamber Music",
        description: "Double bass in chamber ensembles",
        defaultDuration: "1-2 hours",
        priceRange: "£250-450",
        commonVenues: ["Concert halls", "Churches", "Private venues", "Hotels"]
      },
      {
        id: "wedding-double-bass",
        name: "Wedding Reception",
        description: "Double bass accompaniment for wedding entertainment",
        defaultDuration: "2-4 hours",
        priceRange: "£300-500",
        commonVenues: ["Hotels", "Wedding venues", "Function rooms", "Marquees"]
      }
