...
export const schemas = {
  ...
  createBooking: insertBookingSchema.omit({
    ...
    dueDate: z.coerce.date().optional().nullable(), // Ensure date coercion for payment terms
  ...
  updateBooking: z.object({
    ...
    // Additional booking fields that were missing
    ...
    venueContact: z.string().optional().nullable(),
    soundTechContact: z.string().optional().nullable(),
    stageSize: z.string().optional().nullable(),
    powerEquipment: z.string().optional().nullable(),
    styleMood: z.string().optional().nullable(),
    mustPlaySongs: z.string().optional().nullable(),
    avoidSongs: z.string().optional().nullable(),
    setOrder: z.string().optional().nullable(),
    firstDanceSong: z.string().optional().nullable(),
    processionalSong: z.string().optional().nullable(),
    signingRegisterSong: z.string().optional().nullable(),
    recessionalSong: z.string().optional().nullable(),
    specialDedications: z.string().optional().nullable(),
    guestAnnouncements: z.string().optional().nullable(),
    loadInInfo: z.string().optional().nullable(),
    soundCheckTime: z.string().optional().nullable(),
    weatherContingency: z.string().optional().nullable(),
    ...
    referenceTracks: z.string().optional().nullable(),
    photoPermission: z.boolean().optional(),
    encoreAllowed: z.boolean().optional(),
    encoreSuggestions: z.string().optional().nullable(),
    distance: z.string().optional().nullable(),
    distanceValue: z.number().optional().nullable(),
