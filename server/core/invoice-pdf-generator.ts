  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        /* PAGE BREAK CONTROLS - OPTIMIZED FOR PROPER SPLITTING */
        .no-page-break {
        ...
        /* KEEP TABLE AND TOTALS TOGETHER */
        .items-and-totals-wrapper {
          page-break-inside: avoid;
          break-inside: avoid;
        }
    ...
    <body>
      ...
      <!-- ITEMS TABLE AND TOTALS WRAPPER -->
      <div class="items-and-totals-wrapper">
