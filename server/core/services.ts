...
// Re-export the provider abstraction layer for backward compatibility
export { EmailService, emailService } from './email-provider-abstraction';

// Export 'services' as an alias to 'emailService' for backward compatibility
export { emailService as services } from './email-provider-abstraction';

// Export standalone template generation function for invoices
export function generateInvoiceEmailHTML(invoice: any, userSettings: any, pdfUrl: string) {
...
// OLD EmailService class - keeping for reference but not exported
...
// OLD export - now using abstraction layer export at top of file
// export const services = new EmailService_OLD();