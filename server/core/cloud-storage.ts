...
<body>
    ...
    <div class="main-container">
        ...
        <div class="signing-section">
            ...
            <a href="${process.env.REPLIT_DEV_DOMAIN || 'https://f19aba74-886b-4308-a2de-cc9ba5e94af8-00-2ux7uy3ch9t9f.janeway.replit.dev'}/api/contracts/public/${contract.id}/pdf" target="_blank" class="pdf-link">📄 View Full Contract PDF</a>
