// Main storage module that combines all storage modules for backwards compatibility
...
/**
 * Storage class that provides backwards compatibility by delegating to specific storage modules
 * This allows gradual migration while maintaining all existing imports
 */
export class Storage {
  ...
  async createUser(data: any) {
    return userStorage.createUser(data);
  }

  async updateUser(id: string, data: any) {
    return userStorage.updateUser(id, data);
  }

  async setPhoneVerified(phoneNumber: string) {
    return userStorage.setPhoneVerified(phoneNumber);
  }

  async setEmailVerified(email: string) {
    return userStorage.setEmailVerified(email);
  }
  ...
  async createSession(sid: string, sessionData: any) {
    return userStorage.createSession(sid, sessionData);
  }

  async getSession(sid: string) {
    return userStorage.getSession(sid);
  }

  async updateSession(sid: string, sessionData: any) {
    return userStorage.updateSession(sid, sessionData);
  }

  async deleteSession(sid: string) {
    return userStorage.deleteSession(sid);
  }

  async deleteExpiredSessions() {
    return userStorage.deleteExpiredSessions();
  }
  ...
  async createBooking(data: any) {
    return bookingStorage.createBooking(data);
  }
  ...
  async getBookingStats(userId: string) {
    return bookingStorage.getBookingStats(userId);
  }

  async getRecentBookings(userId: string, limit?: number) {
    return bookingStorage.getRecentBookings(userId, limit);
  }

  async getBookingsByStatus(userId: string, status: string) {
    return bookingStorage.getBookingsByStatus(userId, status);
  }

  async getUpcomingBookings(userId: string) {
    return bookingStorage.getUpcomingBookings(userId);
  }
  ...
  async updateUserPassword(id: string, password: string) {
    return userStorage.updateUser(id, { password });
  }
  ...
  // ===== LEGACY CONTRACT SIGNING METHOD =====
  ...
  // ===== LEGACY EMAIL TEMPLATE METHODS (for backward compatibility) =====
