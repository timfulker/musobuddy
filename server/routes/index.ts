...
import { emailFailureRoutes } from "./email-failure-routes";
...
export async function registerRoutes(app: Express) {
  ...
  // Register email failure routes
  app.use('/api', emailFailureRoutes);
  console.log('📧 [CENTRAL-ROUTER] Email failure routes registered at /api/email-failures');
