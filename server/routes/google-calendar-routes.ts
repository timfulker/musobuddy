...
export function registerGoogleCalendarRoutes(app: Express) {
  ...
  // Start OAuth flow
  app.get('/api/google-calendar/auth', authenticate, async (req: AuthenticatedRequest, res) => {
    try {
  ...
  app.get('/api/google-calendar/status', authenticate, async (req: AuthenticatedRequest, res) => {
    try {
      const userId = req.user?.id;
  ...
  app.post('/api/google-calendar/settings', authenticate, async (req: AuthenticatedRequest, res) => {
    try {
      const userId = req.user?.id;
  ...
  app.post('/api/google-calendar/sync', authenticate, async (req: AuthenticatedRequest, res: Response) => {
    try {
      const userId = req.user?.id;
  ...
  app.delete('/api/google-calendar/disconnect', authenticate, async (req: AuthenticatedRequest, res) => {
    try {
      const userId = req.user?.id;
