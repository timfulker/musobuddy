...
export async function generateContractPDF(
  ...
  try {
    ...
    // REMOVED: AI optimization (no more wasted API calls)
    console.log('🔧 Using improved template with better alignment (no AI calls needed)...');
    
    /* DISABLED AI OPTIMIZATION TO SAVE COSTS
    try {
...
<head>
    ...
    <style>
        * {
        ...
        /* Event Details Grid - IMPROVED ALIGNMENT */
        .event-details {
            display: grid;
        ...
        /* Payment Section - IMPROVED ALIGNMENT AND SPACING */
        .payment-section {
