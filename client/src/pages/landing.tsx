        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              <Link href="/signup">
                <Button className="bg-primary hover:bg-primary/90 px-4 md:px-6 py-2 font-medium" style={{backgroundColor: 'var(--theme-primary)', color: 'white'}}>
                  Start Free Trial
                </Button>
              </Link>
            </div>
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-16">
            ...
            <div className="max-w-4xl mx-auto mt-16">
              ...
              >
                <source src="https://pub-446248abf8164fb99bee2fc3dc3c513c.r2.dev/videos/main-promo.mov" type="video/quicktime" />
                <source src="https://pub-446248abf8164fb99bee2fc3dc3c513c.r2.dev/videos/main-promo.mov" type="video/mp4" />
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[1fr_1.5fr] gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-gray-100 border-2 border-gray-200 p-6 rounded-2xl shadow-lg">
              ...
              >
                <source src="https://pub-446248abf8164fb99bee2fc3dc3c513c.r2.dev/videos/contract-demo.mov" type="video/quicktime" />
                <source src="https://pub-446248abf8164fb99bee2fc3dc3c513c.r2.dev/videos/contract-demo.mov" type="video/mp4" />
