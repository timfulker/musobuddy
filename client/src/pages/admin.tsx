...
export default function AdminPanel() {
  ...
  // Initialize default template mutation
  const initializeDefaultTemplateMutation = useMutation({
    mutationFn: () => apiRequest('/api/admin/beta-email-templates/init-default', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    }),
    onSuccess: () => {
      ...
      toast({
        ...
        description: "The default beta email template has been created successfully. You can now edit it.",
      });
    },
    onError: (error: any) => {
      toast({
        title: "Error creating default template",
  ...
  // Update template to new format mutation
  const updateTemplateFormatMutation = useMutation({
    mutationFn: () => apiRequest('/api/admin/beta-email-templates/update-to-new-format', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    }),
    onSuccess: () => {
      ...
      toast({
        ...
        description: "Personal message now appears at the top of emails.",
      });
    },
    onError: (error: any) => {
      toast({
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground mb-2">
                              This message will appear at the top of the email, right after the greeting
                            </p>
                            <textarea
                              id="message"
                  ...
                  <div className="space-y-6">
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                      ...
                      <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
                        <li>• Enter the recipient's email, name, and beta code</li>
                        <li>• Add an optional personal message (appears at the top)</li>
                        <li>• Professional HTML email is sent automatically</li>
                        <li>• Includes beta testing guidelines and setup instructions</li>
                        <li>• Mobile-responsive with dark mode support</li>
                      </ul>

                      {activeTemplate?.template && (
                        <div className="mt-3 pt-3 border-t border-blue-200 dark:border-blue-700">
                          <p className="text-xs text-blue-600 dark:text-blue-400 mb-2">
                            If your personal message appears at the bottom instead of the top:
                          </p>
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => updateTemplateFormatMutation.mutate()}
                            disabled={updateTemplateFormatMutation.isPending}
                            className="text-xs h-7 bg-white dark:bg-gray-800"
                          >
                            {updateTemplateFormatMutation.isPending ? "Updating..." : "Fix Template - Move Message to Top"}
                          </Button>
                        </div>
                      )}
                    </div>
