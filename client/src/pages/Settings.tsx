...
export default function Settings() {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="This appears on all invoices and contracts sent to clients. Use your stage name, band name, or legal business name." showIcon={true}>
                    Business Name
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Your main business contact email. This appears on all invoices and contracts as your contact email address for clients to reach you." showIcon={true}>
                    Business Email
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Your business phone number. This appears on all invoices and contracts as your primary contact number for clients." showIcon={true}>
                    Phone
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Your website or social media profile URL. This appears on invoices and contracts to showcase your professional presence online." showIcon={true}>
                    Website (Optional)
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Your VAT registration number or tax ID. If provided, this appears on invoices to show your tax registration status." showIcon={true}>
                    Tax Number (Optional)
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Your business address that appears on invoices and contracts. This helps establish your professional identity and legal location." showIcon={true}>
                      Address Line 1
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Your personal home address for records. This is kept private and separate from your business address." showIcon={true}>
                      Home Address Line 1
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
        ...
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="The name that appears as the sender when clients receive emails from you. Use your professional name or business name for brand recognition." showIcon={true}>
                      Email From Name
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => {
                ...
                return (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">
                      <HelpTooltip content="CRITICAL: This creates your personalized email address (e.g., yourname@enquiries.musobuddy.com). Without this, MusoBuddy cannot send emails to clients. Choose something professional and memorable." showIcon={true}>
                        Email Prefix
                      </HelpTooltip>
                    </FormLabel>
                    <FormControl>
                    ...
                    <FormDescription className="text-xs text-gray-600 dark:text-gray-400">
                      Your personalized email address for client enquiries. Use only lowercase letters (a-z), numbers (0-9), and hyphens (-).
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                );
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Your professional email signature that appears at the end of all emails sent to clients. Include your name, contact details, and website for a polished look." showIcon={true}>
                    Email Signature
                  </HelpTooltip>
                </FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="Automatically forward copies of all MusoBuddy emails to your personal email address. This ensures you never miss client communications even when away from MusoBuddy." showIcon={true}>
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      <HelpTooltip content="CRITICAL: Determines when invoices are due. MusoBuddy automatically calculates invoice due dates based on the performance date and this setting. Example: '7 days after performance' for a June 15th gig = invoice due June 22nd." showIcon={true}>
                        Payment Terms
                      </HelpTooltip>
                    </FormLabel>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">
                      <HelpTooltip content="The sequential number for your next invoice. MusoBuddy automatically increments this number each time you create an invoice to maintain proper invoice numbering." showIcon={true}>
                        Next Invoice Number
                      </HelpTooltip>
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">
                      <HelpTooltip content="Optional text to appear before your invoice number (e.g., 'INV-' creates invoices like INV-0001). Helps organize and identify your invoices professionally." showIcon={true}>
        ...
        <div className="space-y-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel className="text-sm font-medium">
                  <HelpTooltip content="CRITICAL: This is where clients send payment. Include bank name, account name, sort code, and account number. This information appears on invoices when you enable the 'Bank Details' invoice clause." showIcon={true}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Your standard hourly performance rate. This helps AI calculate pricing for quotes and is used as a baseline for all performance fee calculations." showIcon={true}>
                      Base Hourly Rate (£)
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="The minimum number of hours you accept for bookings. This ensures all quotes meet your minimum performance duration requirement." showIcon={true}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="The rate charged for each additional hour beyond your minimum booking hours. This allows flexible pricing for longer performances." showIcon={true}>
            ...
            {isDJSelected && (
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm font-medium">
                      <HelpTooltip content="Your standard rate for DJ services. This is used when DJ is selected as a gig type for AI pricing calculations." showIcon={true}>
                        DJ Service Rate (£)
                      </HelpTooltip>
                    </FormLabel>
                    <FormControl>
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Internal notes about your pricing strategy, seasonal variations, or special considerations. These help AI provide more accurate quotes but are not shared with clients." showIcon={true}>
                      Pricing Notes
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Describe any package deals, discounts, or promotional offers you provide. AI can use this information when suggesting pricing to potential clients." showIcon={true}>
                      Special Offers
                    </HelpTooltip>
                  </FormLabel>
                  <FormControl>
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Your main instrument or performance type. This helps AI understand your services and automatically suggests relevant gig types for bookings." showIcon={true}>
                      Primary Instrument
                    </HelpTooltip>
                  </FormLabel>
                  <Select 
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="text-sm font-medium">
                    <HelpTooltip content="Additional instruments or performance types you offer. Selecting these expands the range of gig types available for your bookings." showIcon={true}>
  ...
  const renderDataPrivacySection = () => (
    <Card className="shadow-lg border-0 bg-gradient-to-br from-white to-gray-50 dark:from-slate-900 dark:to-slate-800">
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            ...
            <Button
              ...
              className="hover:opacity-90 transition-opacity w-full sm:w-auto shrink-0 self-end sm:self-center"
        ...
        <div className="space-y-4 border-t border-gray-200 dark:border-gray-600 pt-6 mt-6">
  ...
  const deleteUserAccount = useMutation({
    ...
    onSuccess: async (data) => {
      ...
      // Sign out the user to clear all sessions
      try {
        await logout();
      } catch (error) {
  ...
  const saveSettings = useMutation({
    ...
    onError: async (error: any) => {
      ...
      // The error from apiRequest is in format: "400: {json}"
      ...
      if (errorField === 'emailPrefix') {
        // Set the error on the field to show it below the input
