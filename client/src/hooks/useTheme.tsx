...
export const themes: Record<ThemeName, Theme> = {
  'purple': {
    ...
    colors: {
      ...
      secondary: '#a855f7',
      accent: '#6366f1',
      background: 'linear-gradient(135deg, #faf7ff 0%, #ede4ff 50%, #f0f9ff 100%)',
      surface: 'linear-gradient(135deg, #ffffff 0%, #faf7ff 60%, #f8fafc 100%)',
      text: '#1e293b',
  ...
  'ocean-blue': {
    ...
    colors: {
      ...
      surface: 'linear-gradient(135deg, #ffffff 0%, #f0f9ff 60%, #e0f7fa 100%)',
      text: '#0c4a6e',
  ...
  'forest-green': {
    ...
    colors: {
      ...
      surface: 'linear-gradient(135deg, #ffffff 0%, #f0fdf4 60%, #f7fef8 100%)',
      text: '#14532d',
  ...
  'clean-pro-audio': {
    ...
    colors: {
      ...
      secondary: '#9ca3af',
      accent: '#ffeb3b',
      background: 'linear-gradient(135deg, #fef7f7 0%, #fee2e2 50%, #fef3c7 100%)',
      surface: 'linear-gradient(135deg, #ffffff 0%, #fef7f7 60%, #fffbeb 100%)',
      text: '#2c2c2c',
  ...
  'midnight-blue': {
    ...
    colors: {
      ...
      secondary: '#1e1e3f',
      accent: '#4169e1',
      background: 'linear-gradient(135deg, #f0f8ff 0%, #dbeafe 50%, #e0e7ff 100%)',
      surface: 'linear-gradient(135deg, #ffffff 0%, #f0f8ff 60%, #f1f5f9 100%)',
      text: '#1a1a1a',
