-- COMPLETE SUPABASE SCHEMA - Exact match for Neon database
-- ALL 37 tables with ALL columns exactly as they exist in production

-- Enable required extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Extract and modify each table from Neon schema with IF NOT EXISTS
