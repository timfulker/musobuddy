// AI-Generated Professional Contract Template
...
<body>
    <div class="contract-status">DRAFT</div>
    
    <header class="contract-header">
        <div class="logo">MusoBuddy</div>
        <div class="tagline">Less admin, more music</div>
        <div class="contract-number">Contract #: 30/08/2025 - Kelly Boyd</div>
    </header>
        ...
        <div class="grid">
            <div>
                <div class="detail-group">
                    ...
                    <div class="detail-value">Kelly Boyd</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Email</div>
                    <div class="detail-value">timfulker@gmail.com</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Phone</div>
                    <div class="detail-value">07989676155</div>
                </div>
            </div>
            <div>
                <div class="detail-group">
                    <div class="detail-label">Business</div>
                    <div class="detail-value">Tim Fulker Music</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Email</div>
                    <div class="detail-value">timfulkermusic@gmail.com</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Phone</div>
                    <div class="detail-value">07764190034</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid">
            <div>
                <div class="detail-group">
                    ...
                    <div class="detail-value">Saturday, 30 August 2025</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Time</div>
                    <div class="detail-value">19:00 - 22:00</div>
                </div>
            </div>
            <div>
                <div class="detail-group">
                    <div class="detail-label">Venue</div>
                    <div class="detail-value">Kelly's House</div>
                </div>
                <div class="detail-group">
                    <div class="detail-label">Address</div>
                    <div class="detail-value">94, Hambledon Road, Waterlooville, PO7 6UP</div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section financial">
        ...
        <div class="grid">
            <div class="detail-group">
                ...
                <div class="detail-value amount">£310.00</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Deposit Required</div>
                <div class="detail-value amount">£23.00</div>
            </div>
            <div class="detail-group">
                <div class="detail-label">Balance Due</div>
                <div class="detail-value amount">£287.00</div>
            </div>
        </div>
    </div>
    ...
    <div class="section">
        ...
        <div class="detail-group">
            ...
            <div class="detail-value">1 PA speaker</div>
        </div>
        <div class="detail-group">
            <div class="detail-label">Special Requirements</div>
            <div class="detail-value">vegan</div>
        </div>
    </div>
    ...
    <div class="section terms">
        ...
        <ul>
            ...
            <li>Client to provide suitable food and drink if performance exceeds 3 hours including setup</li>
