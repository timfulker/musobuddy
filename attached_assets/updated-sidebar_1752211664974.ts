    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto p-4 space-y-1 pb-20">
          <Link href="/" onClick={() => !isDesktop && onClose()} className={cn(
          ...
          <Link href="/enquiries" onClick={() => !isDesktop && onClose()} className={cn(
          ...
          <Link href="/address-book" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
          ...
          <Link href="/contracts" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/contracts") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
          ...
          <Link href="/invoices" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/invoices") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
          ...
          <Link href="/calendar" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/calendar") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
          ...
          <Link href="/compliance" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/compliance") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
          ...
          <Link href="/settings" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/settings") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
          ...
          <Link href="/templates" onClick={() => !isDesktop && onClose()} className={cn(
            "flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors",
            isActive("/templates") 
              ? "bg-purple-600 text-white font-medium" 
              : "text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800"
